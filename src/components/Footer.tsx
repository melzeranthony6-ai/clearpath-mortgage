      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="grid grid-cols-1 sm:grid-cols-4 gap-10 pb-10 border-b border-white/10">
          <div className="sm:col-span-2">
            ...
            <p className="text-navy-400 text-sm leading-relaxed max-w-xs">
              Helping Ontario families find better mortgage rates since 2018. Licensed, transparent, and always working
        ...
        <div className="pt-8 text-center sm:text-left">
          <p className="text-navy-400 text-xs leading-relaxed max-w-4xl mx-auto sm:mx-0 mb-3">
            ...
            licensed by the Financial Services Regulatory Authority of Ontario (FSRA). All mortgage rates are subject to
            lender approval and may change without notice. OAC. This website is for informational purposes only and
